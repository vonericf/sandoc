<div>
    <input type="search" name="serch" placeholder="Search Specialty, Hospital name or your Doctor's name..." class="w-full h-10 px-5 pr-10 text-sm bg-white rounded-full w focus:outline-none">
